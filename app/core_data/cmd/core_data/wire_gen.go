...
func wireApp(confServer *conf.Server, confData *conf.Data, logger log.Logger, aiAnalyze *conf.AiAnalyze) (*kratos.App, func(), error) {
	...
	httpServer := server.NewHTTPServer(confServer, logger, dataData, submitLogService, spiderService, statisticService, contestLogService, bulletinService, problemService, emergencyService)
