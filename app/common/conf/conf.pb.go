...
func (*Data_Database) Descriptor() ([]byte, []int) {
	return file_app_common_conf_conf_proto_rawDescGZIP(), []int{2, 0}
}
...
func (*Data_Redis) Descriptor() ([]byte, []int) {
	return file_app_common_conf_conf_proto_rawDescGZIP(), []int{2, 1}
}
...
const file_app_common_conf_conf_proto_rawDesc = "" +
	...
	"kratos.api\x1a\x1egoogle/protobuf/duration.proto\"\xe2\x01\n" +
	"\tBootstrap\x12*\n" +
	...
	"\n" +
	"ai_analyze\x18\x05 \x01(\v2\x15.kratos.api.AiAnalyzeR\taiAnalyze\"\xbf\x03\n" +
	"\x06Server\x12+\n" +
	...
	"\x15config_encryption_key\x18\x06 \x01(\tR\x13configEncryptionKey\x1ai\n" +
	"\x04HTTP\x12\x18\n" +
	...
	"\x06secret\x18\x02 \x01(\tR\x06secret\"z\n" +
	"\x04SMTP\x12\x12\n" +
...
var file_app_common_conf_conf_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_app_common_conf_conf_proto_goTypes = []any{
	(*Bootstrap)(nil),           // 0: kratos.api.Bootstrap
	(*Server)(nil),              // 1: kratos.api.Server
	(*Data)(nil),                // 2: kratos.api.Data
	(*Agent)(nil),               // 3: kratos.api.Agent
	(*SMTP)(nil),                // 4: kratos.api.SMTP
	(*AiAnalyze)(nil),           // 5: kratos.api.AiAnalyze
...
var file_app_common_conf_conf_proto_depIdxs = []int32{
	...
	3,  // 2: kratos.api.Bootstrap.agent:type_name -> kratos.api.Agent
	4,  // 3: kratos.api.Bootstrap.smtp:type_name -> kratos.api.SMTP
	5,  // 4: kratos.api.Bootstrap.ai_analyze:type_name -> kratos.api.AiAnalyze
