...
const file_user_v1_auth_proto_rawDesc = "" +
	"\n" +
	"\x12user/v1/auth.proto\x12\vapi.user.v1\x1a\x1cgoogle/api/annotations.proto\"B\n" +
	"\bLoginReq\x12\x1a\n" +
	"\busername\x18\x01 \x01(\tR\busername\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\tR\bpassword\"@\n" +
	"\bLoginRes\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x1a\n" +
	"\bjwtToken\x18\x02 \x01(\tR\bjwtToken2]\n" +
	"\x04Auth\x12U\n" +
	"\x05Login\x12\x15.api.user.v1.LoginReq\x1a\x15.api.user.v1.LoginRes\"\x1e\x82\xd3\xe4\x93\x02\x18:\x01*\"\x13/v1/user/auth/loginB)\n" +
	"\vapi.user.v1P\x01Z\x18cwxu-algo/api/user/v1;v1b\x06proto3"
...
var file_user_v1_auth_proto_depIdxs = []int32{
	...
	1, // 1: api.user.v1.Auth.Login:output_type -> api.user.v1.LoginRes
