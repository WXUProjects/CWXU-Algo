...
const file_user_v1_auth_proto_rawDesc = "" +
	...
	"\bRegister\x12\x18.api.user.v1.RegisterReq\x1a\x18.api.user.v1.RegisterRes\"!\x82\xd3\xe4\x93\x02\x1b:\x01*\"\x16/v1/user/auth/registerB)\n" +
...
var file_user_v1_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
