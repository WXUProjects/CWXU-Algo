...
func (*GetByIdsRes_UserProfile) Descriptor() ([]byte, []int) {
	return file_user_v1_profile_profile_proto_rawDescGZIP(), []int{29, 0}
}
...
const file_user_v1_profile_profile_proto_rawDesc = "" +
	...
	"\x05email\x18\x01 \x01(\tR\x05email2\xd0\x13\n" +
	"\aProfile\x12_\n" +
...
var file_user_v1_profile_profile_proto_msgTypes = make([]protoimpl.MessageInfo, 47)
var file_user_v1_profile_profile_proto_goTypes = []any{
	...
	(*GetStaffOrgIdsReq)(nil),          // 24: api.user.v1.GetStaffOrgIdsReq
	(*GetStaffOrgIdsRes)(nil),          // 25: api.user.v1.GetStaffOrgIdsRes
	(*GetNonPublicOrgUserIdsReq)(nil),  // 26: api.user.v1.GetNonPublicOrgUserIdsReq
	(*GetNonPublicOrgUserIdsRes)(nil),  // 27: api.user.v1.GetNonPublicOrgUserIdsRes
	(*GetByIdsReq)(nil),                // 28: api.user.v1.GetByIdsReq
	(*GetByIdsRes)(nil),                // 29: api.user.v1.GetByIdsRes
	(*DeleteReq)(nil),                  // 30: api.user.v1.DeleteReq
	(*DeleteRes)(nil),                  // 31: api.user.v1.DeleteRes
	(*GetSyncPoliciesReq)(nil),         // 32: api.user.v1.GetSyncPoliciesReq
	(*UserSyncPolicy)(nil),             // 33: api.user.v1.UserSyncPolicy
	(*GetSyncPoliciesRes)(nil),         // 34: api.user.v1.GetSyncPoliciesRes
	(*GetByUsernameReq)(nil),           // 35: api.user.v1.GetByUsernameReq
	(*GetFollowingIdsReq)(nil),         // 36: api.user.v1.GetFollowingIdsReq
	(*GetFollowingIdsRes)(nil),         // 37: api.user.v1.GetFollowingIdsRes
	(*FilterPublicFeedUserIdsReq)(nil), // 38: api.user.v1.FilterPublicFeedUserIdsReq
	(*FilterPublicFeedUserIdsRes)(nil), // 39: api.user.v1.FilterPublicFeedUserIdsRes
	(*GetContactEmailReq)(nil),         // 40: api.user.v1.GetContactEmailReq
	(*GetContactEmailRes)(nil),         // 41: api.user.v1.GetContactEmailRes
	(*GetByIdRes_Spiders)(nil),         // 42: api.user.v1.GetByIdRes.Spiders
	(*GetByNameRes_UserList)(nil),      // 43: api.user.v1.GetByNameRes.UserList
	(*GetListRes_OrgBrief)(nil),        // 44: api.user.v1.GetListRes.OrgBrief
	(*GetListRes_List)(nil),            // 45: api.user.v1.GetListRes.List
	(*GetByIdsRes_UserProfile)(nil),    // 46: api.user.v1.GetByIdsRes.UserProfile
}
var file_user_v1_profile_profile_proto_depIdxs = []int32{
	42, // 0: api.user.v1.GetByIdRes.spiders:type_name -> api.user.v1.GetByIdRes.Spiders
	43, // 1: api.user.v1.GetByNameRes.list:type_name -> api.user.v1.GetByNameRes.UserList
	45, // 2: api.user.v1.GetListRes.list:type_name -> api.user.v1.GetListRes.List
	46, // 3: api.user.v1.GetByIdsRes.profiles:type_name -> api.user.v1.GetByIdsRes.UserProfile
	33, // 4: api.user.v1.GetSyncPoliciesRes.policies:type_name -> api.user.v1.UserSyncPolicy
	44, // 5: api.user.v1.GetListRes.List.orgs:type_name -> api.user.v1.GetListRes.OrgBrief
	...
	24, // 18: api.user.v1.Profile.GetStaffOrgIds:input_type -> api.user.v1.GetStaffOrgIdsReq
	26, // 19: api.user.v1.Profile.GetNonPublicOrgUserIds:input_type -> api.user.v1.GetNonPublicOrgUserIdsReq
	28, // 20: api.user.v1.Profile.GetByIds:input_type -> api.user.v1.GetByIdsReq
	32, // 21: api.user.v1.Profile.GetSyncPolicies:input_type -> api.user.v1.GetSyncPoliciesReq
	30, // 22: api.user.v1.Profile.Delete:input_type -> api.user.v1.DeleteReq
	35, // 23: api.user.v1.Profile.GetByUsername:input_type -> api.user.v1.GetByUsernameReq
	36, // 24: api.user.v1.Profile.GetFollowingIds:input_type -> api.user.v1.GetFollowingIdsReq
	38, // 25: api.user.v1.Profile.FilterPublicFeedUserIds:input_type -> api.user.v1.FilterPublicFeedUserIdsReq
	40, // 26: api.user.v1.Profile.GetContactEmail:input_type -> api.user.v1.GetContactEmailReq
	1,  // 27: api.user.v1.Profile.GetById:output_type -> api.user.v1.GetByIdRes
	3,  // 28: api.user.v1.Profile.GetByName:output_type -> api.user.v1.GetByNameRes
	5,  // 29: api.user.v1.Profile.GetList:output_type -> api.user.v1.GetListRes
	7,  // 30: api.user.v1.Profile.Update:output_type -> api.user.v1.UpdateRes
	9,  // 31: api.user.v1.Profile.MoveGroup:output_type -> api.user.v1.MoveGroupRes
	11, // 32: api.user.v1.Profile.SetEmailEnabled:output_type -> api.user.v1.SetEmailEnabledRes
	13, // 33: api.user.v1.Profile.SetProblemPipeline:output_type -> api.user.v1.SetProblemPipelineRes
	15, // 34: api.user.v1.Profile.SetSyncIntervals:output_type -> api.user.v1.SetSyncIntervalsRes
	17, // 35: api.user.v1.Profile.SetSyncExempt:output_type -> api.user.v1.SetSyncExemptRes
	19, // 36: api.user.v1.Profile.ClearDormant:output_type -> api.user.v1.ClearDormantRes
	21, // 37: api.user.v1.Profile.GetUserIdsByGroup:output_type -> api.user.v1.GetUserIdsByGroupRes
	23, // 38: api.user.v1.Profile.GetUserIdsByOrg:output_type -> api.user.v1.GetUserIdsByOrgRes
	25, // 39: api.user.v1.Profile.GetStaffOrgIds:output_type -> api.user.v1.GetStaffOrgIdsRes
	27, // 40: api.user.v1.Profile.GetNonPublicOrgUserIds:output_type -> api.user.v1.GetNonPublicOrgUserIdsRes
	29, // 41: api.user.v1.Profile.GetByIds:output_type -> api.user.v1.GetByIdsRes
	34, // 42: api.user.v1.Profile.GetSyncPolicies:output_type -> api.user.v1.GetSyncPoliciesRes
	31, // 43: api.user.v1.Profile.Delete:output_type -> api.user.v1.DeleteRes
	1,  // 44: api.user.v1.Profile.GetByUsername:output_type -> api.user.v1.GetByIdRes
	37, // 45: api.user.v1.Profile.GetFollowingIds:output_type -> api.user.v1.GetFollowingIdsRes
	39, // 46: api.user.v1.Profile.FilterPublicFeedUserIds:output_type -> api.user.v1.FilterPublicFeedUserIdsRes
	41, // 47: api.user.v1.Profile.GetContactEmail:output_type -> api.user.v1.GetContactEmailRes
