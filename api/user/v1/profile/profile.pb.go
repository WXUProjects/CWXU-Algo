...
const file_user_v1_profile_profile_proto_rawDesc = "" +
	...
	"\tDeleteRes\x12\x12\n" +
	"\x04code\x18\x01 \x01(\x03R\x04code\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage2\xc6\a\n" +
	"\aProfile\x12_\n" +
...
var file_user_v1_profile_profile_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_user_v1_profile_profile_proto_goTypes = []any{
	...
	(*DeleteReq)(nil),               // 16: api.user.v1.DeleteReq
	(*DeleteRes)(nil),               // 17: api.user.v1.DeleteRes
	(*GetByIdRes_Spiders)(nil),      // 18: api.user.v1.GetByIdRes.Spiders
	(*GetByNameRes_UserList)(nil),   // 19: api.user.v1.GetByNameRes.UserList
	(*GetListRes_List)(nil),         // 20: api.user.v1.GetListRes.List
	(*GetByIdsRes_UserProfile)(nil), // 21: api.user.v1.GetByIdsRes.UserProfile
}
var file_user_v1_profile_profile_proto_depIdxs = []int32{
	18, // 0: api.user.v1.GetByIdRes.spiders:type_name -> api.user.v1.GetByIdRes.Spiders
	19, // 1: api.user.v1.GetByNameRes.list:type_name -> api.user.v1.GetByNameRes.UserList
	20, // 2: api.user.v1.GetListRes.list:type_name -> api.user.v1.GetListRes.List
	21, // 3: api.user.v1.GetByIdsRes.profiles:type_name -> api.user.v1.GetByIdsRes.UserProfile
	...
	16, // 12: api.user.v1.Profile.Delete:input_type -> api.user.v1.DeleteReq
	1,  // 13: api.user.v1.Profile.GetById:output_type -> api.user.v1.GetByIdRes
	3,  // 14: api.user.v1.Profile.GetByName:output_type -> api.user.v1.GetByNameRes
	5,  // 15: api.user.v1.Profile.GetList:output_type -> api.user.v1.GetListRes
	7,  // 16: api.user.v1.Profile.Update:output_type -> api.user.v1.UpdateRes
	9,  // 17: api.user.v1.Profile.MoveGroup:output_type -> api.user.v1.MoveGroupRes
	11, // 18: api.user.v1.Profile.SetEmailEnabled:output_type -> api.user.v1.SetEmailEnabledRes
	13, // 19: api.user.v1.Profile.GetUserIdsByGroup:output_type -> api.user.v1.GetUserIdsByGroupRes
	15, // 20: api.user.v1.Profile.GetByIds:output_type -> api.user.v1.GetByIdsRes
	17, // 21: api.user.v1.Profile.Delete:output_type -> api.user.v1.DeleteRes
